    ...
    with open(writefilename, 'w') as csv_file:
        ...
        while traci.simulation.getMinExpectedNumber() > 0:
            ...
            for vehicle_id in vehicle_ids:
                ...
                csv_file.write(f"{vehicle_id} {simulation_time} {-1} {position[1]*scale} {speed} {accel} {-1} {cls} {-1} {-1}\n")
...
if __name__ == "__main__":
    ...
    # create random vehicle type distribution (see vTypeDist.txt)
    # https://github.com/eclipse-sumo/sumo/blob/main/tools/createVehTypeDistribution.py
